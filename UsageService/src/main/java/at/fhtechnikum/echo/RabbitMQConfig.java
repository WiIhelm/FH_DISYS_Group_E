...
public class RabbitMQConfig {
    ...
    public static final String INPUT_QUEUE = "echo.usage";
    public static final String OUTPUT_QUEUE = "echo.update";
    ...
    public Binding inputBinding() {
        return BindingBuilder.bind(inputQueue()).to(textProcessingExchange()).with("echo.usage");
    }

    @Bean
    public Binding outputBinding() {
        return BindingBuilder.bind(outputQueue()).to(textProcessingExchange()).with("echo.update");
    }
